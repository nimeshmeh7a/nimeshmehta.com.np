              ...
              <div className="lg:w-2/3" data-aos="fade-left" data-aos-delay="300">
                <div className="bg-white rounded-2xl p-8 shadow-lg border border-gray-100 hover:shadow-xl transition-shadow duration-300">
                  <p className="text-gray-600 mb-6 text-lg leading-relaxed" data-aos="fade-up" data-aos-delay="400">
                   Skilled in developing scalable, production-ready web applications using Bubble.io, with a focus on efficient workflows, structured database design, seamless integrations, and performance optimization.
                  </p>
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    {[
  "Integrate external services and extend application functionality",
  "Implement secure and reliable payment workflows",
  "Build systems for managing users and internal operations",
  "Develop responsive, user-friendly interfaces from designs",
  "Create scalable e-commerce and web platforms",
  "Enable API connectivity and real-time automation"
].map((skill, index) => (
